import { b as push, c as bind_props, p as pop, i as copy_payload, j as assign_payload, k as spread_props, f as ensure_array_like, d as stringify } from "./index.js";
...
function InfoCardButton($$payload, $$props) {
  ...
  bind_props($$props, { image, title, description, link, onClick });
  pop();
}
function AuthenticationView($$payload, $$props) {
  push();
    ...
    component?.($$payload2, {
      ...
      $$slots: {
        body: ($$payload3) => {
          ...
          if (cards.length == 0) {
            $$payload3.out += "<!--[-->";
            $$payload3.out += `<h3 class="text-2xl font-medium text-gray-800 mt-5 pt-2">${escape_html(form.title)}</h3>`;
          } else {
            $$payload3.out += "<!--[!-->";
          }
          $$payload3.out += `<!--]--></div> `;
          if (cards.length > 0) {
            ...
            for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
              ...
              InfoCardButton($$payload3, spread_props([card]));
            }
            $$payload3.out += `<!--]--></div>`;
          } else {
            $$payload3.out += "<!--[!-->";
        ...
        footer: ($$payload3) => {
          ...
          if (cards.length == 0) {
            ...
            Button($$payload3, spread_props([{ width: "w-[120px]" }, form.footer.button]));
            $$payload3.out += `<!----></div>`;
          } else {
            $$payload3.out += "<!--[!-->";
          }
