...
const systemSettingsStore = writable({
  instance_id: 0,
  account_back_url: "",
...
const CITIES_ENUM_ENGLAND = [
  { index: 1, name: "Aberdeen", country: "Scotland" },
  { index: 2, name: "Armagh", country: "Northern Ireland" },
  { index: 3, name: "Bangor", country: "Wales" },
  { index: 4, name: "Bath", country: "England" },
  { index: 5, name: "Belfast", country: "Northern Ireland" },
  { index: 6, name: "Birmingham", country: "England" },
  { index: 7, name: "Bradford", country: "England" },
  { index: 8, name: "Brighton and Hove", country: "England" },
  { index: 9, name: "Bristol", country: "England" },
  { index: 10, name: "Cambridge", country: "England" },
  { index: 11, name: "Canterbury", country: "England" },
  { index: 12, name: "Cardiff", country: "Wales" },
  { index: 13, name: "Carlisle", country: "England" },
  { index: 14, name: "Chelmsford", country: "England" },
  { index: 15, name: "Chester", country: "England" },
  { index: 16, name: "Chichester", country: "England" },
  { index: 17, name: "Coventry", country: "England" },
  { index: 18, name: "Derby", country: "England" },
  { index: 19, name: "Derry (Londonderry)", country: "Northern Ireland" },
  { index: 20, name: "Dundee", country: "Scotland" },
  { index: 21, name: "Durham", country: "England" },
  { index: 22, name: "Edinburgh", country: "Scotland" },
  { index: 23, name: "Ely", country: "England" },
  { index: 24, name: "Exeter", country: "England" },
  { index: 25, name: "Glasgow", country: "Scotland" },
  { index: 26, name: "Gloucester", country: "England" },
  { index: 27, name: "Hereford", country: "England" },
  { index: 28, name: "Inverness", country: "Scotland" },
  { index: 29, name: "Kingston upon Hull (Hull)", country: "England" },
  { index: 30, name: "Lancaster", country: "England" },
  { index: 31, name: "Leeds", country: "England" },
  { index: 32, name: "Leicester", country: "England" },
  { index: 33, name: "Lichfield", country: "England" },
  { index: 34, name: "Lincoln", country: "England" },
  { index: 35, name: "Lisburn", country: "Northern Ireland" },
  { index: 36, name: "Liverpool", country: "England" },
  { index: 37, name: "London", country: "England" },
  { index: 38, name: "Manchester", country: "England" },
  { index: 39, name: "Newcastle upon Tyne", country: "England" },
  { index: 40, name: "Newport", country: "Wales" },
  { index: 41, name: "Newry", country: "Northern Ireland" },
  { index: 42, name: "Norwich", country: "England" },
  { index: 43, name: "Nottingham", country: "England" },
  { index: 44, name: "Oxford", country: "England" },
  { index: 45, name: "Perth", country: "Scotland" },
  { index: 46, name: "Peterborough", country: "England" },
  { index: 47, name: "Plymouth", country: "England" },
  { index: 48, name: "Portsmouth", country: "England" },
  { index: 49, name: "Preston", country: "England" },
  { index: 50, name: "Ripon", country: "England" },
  { index: 51, name: "Salford", country: "England" },
  { index: 52, name: "Salisbury", country: "England" },
  { index: 53, name: "Sheffield", country: "England" },
  { index: 54, name: "Southampton", country: "England" },
  { index: 55, name: "St Albans", country: "England" },
  { index: 56, name: "St Asaph", country: "Wales" },
  { index: 57, name: "St Davids", country: "Wales" },
  { index: 58, name: "Stirling", country: "Scotland" },
  { index: 59, name: "Stoke-on-Trent", country: "England" },
  { index: 60, name: "Sunderland", country: "England" },
  { index: 61, name: "Swansea", country: "Wales" },
  { index: 62, name: "Truro", country: "England" },
  { index: 63, name: "Wakefield", country: "England" },
  { index: 64, name: "Wells", country: "England" },
  { index: 65, name: "Westminster", country: "England" },
  { index: 66, name: "Winchester", country: "England" },
  { index: 67, name: "Wolverhampton", country: "England" },
  { index: 68, name: "Worcester", country: "England" },
  { index: 69, name: "Wrexham", country: "Wales" },
  { index: 70, name: "York", country: "England" }
];
const KENYA_CITIES_ENUM = [
  { country: "KE", name: "Nairobi", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Mombasa", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Kiambu", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Kisumu", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Machakos", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Nakuru", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Uasin Gishu", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Kajiado", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Murang'a", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Makueni", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Meru", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Embu", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Kitui", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Kwale", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Kilifi", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Nyeri", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Kirinyaga", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Tana River", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Lamu", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Taita Taveta", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Marsabit", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Isiolo", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Tharaka-Nithi", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Nyandarua", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Kakamega", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Vihiga", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Bungoma", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Busia", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Siaya", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Turkana", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "West Pokot", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Samburu", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Trans Nzoia", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Elgeyo Marakwet", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Nandi", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Baringo", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Laikipia", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Narok", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Kericho", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Bomet", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Homa Bay", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Migori", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Kisii", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Nyamira", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Garissa", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Wajir", lat: "0.0000", lng: "0.0000" },
  { country: "KE", name: "Mandera", lat: "0.0000", lng: "0.0000" }
];
const CityList = CITIES_ENUM.map((item) => ({
  ...item,
  value: item.name,
  label: item.name
}));
const CityList_KE = KENYA_CITIES_ENUM.map((item) => ({
  ...item,
  value: item.name,
  label: item.name
}));
const CityList_England = CITIES_ENUM_ENGLAND.map((item) => ({
  ...item,
  value: item.name,
  label: item.name
}));
...
const instanceConfig = {
  ...
  globalclimateliteracy: {
    ...
    meta_settings: {
      ...
      meta_description: "Welcome to Global Climate Literacy Competitions, an initiative that inspires students worldwide to build climate literacy and drive action through games and competitions!",
      fav_icons: {
  ...
  singaporegreenguardians: {
    ...
    meta_settings: {
      ...
      meta_description: "Welcome to Singapore Green Guardians Competitions, an initiative that inspires students worldwide to build climate literacy and drive action through games and competitions!",
      fav_icons: {
  ...
  healthx: {
    ...
    meta_settings: {
      ...
      meta_description: "Up for a challenge? Head over to healthx.knowledgeplatform.com where you learn, engage, and challenge friends with fun games!",
      fav_icons: {
  ...
  pocketgames: {
    ...
    meta_settings: {
      title: "Pocket Games",
      meta_description: "Up for a challenge? Head over to pocketgames.knowledgeplatform.com where you learn, engage, and challenge friends with fun games!",
      fav_icons: {
...
function getFormViewLogo() {
  const Logo = get(systemSettingsStore).logo.web_dark;
  return Logo;
}
function getSystemDarkLogo() {
...
const isShupavu = currentInstance()?.isShupavuGames;
currentInstance()?.isBonzo;
const isGCLC = currentInstance()?.isGlobalClimateLiteracy;
const isGlobalClimateLiteracy = currentInstance()?.isGlobalClimateLiteracy;
const isPocketGames = currentInstance()?.isPocketGames;
const isQuotient = currentInstance()?.isQuotient;
currentInstance()?.isHealthx;
const isSGG = currentInstance()?.isSingaporeGreenGuardians;
export {
  INSTANCES_ID as I,
  isShupavu as a,
  instanceConfig as b,
  configurations as c,
  getFormViewLogo as d,
  isPocketGames as e,
  isQuotient as f,
  getSystemDarkLogo as g,
  isSGG as h,
  isGCLC as i,
  isGlobalClimateLiteracy as j,
  getSystemLightLogo as k,
  systemSettingsStore as s
};
