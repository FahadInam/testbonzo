...
let __tla = Promise.all([
  ...
  _page = function($$payload, $$props) {
    ...
    function $$render_inner($$payload2) {
      ...
      $$payload2.out += `<div class="flex justify-center w-full px-4 sm:px-6 md:px-8 lg:px-10"><div class="w-full max-w-screen-xl space-y-6"><div class="w-full mb-8">`;
      ...
      {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `<div class="flex justify-center w-full px-4 sm:px-6 md:px-8 lg:px-10">`;
