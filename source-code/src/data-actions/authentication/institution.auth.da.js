...
import { gclcSignUpFields, handleGoogleLogin, loginFields, signUpFields } from "./common.auth.data";
import { loginUser, refreshUserToken, signUpUserUsingFormData } from "./user.auth.da";
...
export const getSignUpInstitutionForm = async () => ({
...
export const getInstitutionLoginForm = async () => ({
  ...loginFields,
  handleSubmit: async (/** @type {any} */ formData) => {
...
export const institutionLoginFormPopup = async () => ({
...
export const signUpInstitutionFormPopup = async () => ({
...
/**
 * @param {{ instituteName: any; instituteCity: any; schoolNetwork: any; instituteAddress: any; principal: any; contact: any; heardFrom: any; country: any; }} formData
 */
export async function saveInstitutionDetails(formData) {
  const instance_id = get(instanceStore).instance_id;
  const { instituteName, instituteCity, schoolNetwork, instituteAddress, principal, contact, heardFrom, country } =
    formData;
